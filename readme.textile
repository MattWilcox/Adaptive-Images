...
* Is device agnostic (it simply detects the size of the visitors screen)
* IS CMS agnostic (it manages its own image re-sizing, and will work on any CMS or even on flat HTML pages)
* Is entirely autmatic. Once added to your site, you need do no further work.
* Highly configurable
** Set the resolutions you want to become adaptive (usually the same as the ones in your CSS @media queries)
** Decide whether you want to go Mobile First or Desktop First if JavaScript is unavailable
